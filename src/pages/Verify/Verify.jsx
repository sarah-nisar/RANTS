      ...
      {!isVerified ? (
        <div className={styles.beforeVerifyContainer}>
          <span className={styles.verifyDetails}>
            Doc Name:{" "}
            <span className={styles.detailsContent}>gradesheet.pdf</span>
          </span>
          <span className={styles.verifyDetails}>
            Student Email:{" "}
            <span className={styles.detailsContent}>
              rrmaurya_b19@it.vjti.ac.in
            </span>
          </span>
          <span className={styles.verifyDetails}>
            Student Registration Num:{" "}
            <span className={styles.detailsContent}>191080080</span>
          </span>
          <button onClick={checkDocument} className={styles.checkDocBtn}>
            Check Document
          </button>
        </div>
      ) : (
          ...
          <div className={styles.docContainer}>
            {pdfFile ? (
              <div className={styles.documentContainer}>
                <Document
                  file={window.URL.createObjectURL(pdfFile)}
