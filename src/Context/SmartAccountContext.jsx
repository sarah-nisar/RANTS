...
import { supportedChains, activeChainId } from "./constants";
	...
	const getSmartAccount = useCallback(async () => {
		...
		try {
				...
				networkConfig: [
					{
						...
						providerUrl: `https://polygon-mumbai.g.alchemy.com/v2/VU5Z6_VJgdMUgrcfhGsHk2o5tzEfFbhT`,
					},
				],
			});
			...
			smartAccount.on("txMined", (response) => {
				console.log(
					"txMined event received in AddLP via emitter",
					response
				);
			});
			...
			smartAccount.on("error", (response) => {
				console.log(
					"error event received in AddLP via emitter",
					response
				);
			});
